...
@Component({
  selector: 'app-detail-carecallschedule',
  templateUrl: './detail-carecallschedule.component.html',
  styleUrls: ['./detail-carecallschedule.component.scss']
})
export class DetailCarecallscheduleComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<DetailCarecallscheduleComponent>,
